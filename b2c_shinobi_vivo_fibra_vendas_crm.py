...
DATASET = 'coe_testes'
TABLE = 'b2c_shinobi_vivo_fibra_vendas_crm' 
...
QUERY = f"""
    ...
    SELECT 
      ...
      *
    --FROM shinobi-vivo.vivo_fibra.relatorio_vivo_fibra_vendas_crm
    FROM shinobi-vivo.vivo_fibra.relatorio_vivo_fibra_crm_sum
    )
